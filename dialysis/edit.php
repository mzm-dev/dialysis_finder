...
if (isset($_POST['btn-update'])) {
    ...
    if (empty($telPejabat)) {
        ...
        $valid = false;
    } elseif (!filter_var($telPejabat, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => "/^0[1,2,3,4,6,7,8,9]\d{7,8}$/")))) {
    ...
    if (empty($telBimbit)) {
        ...
        $valid = false;
    } elseif (!filter_var($telBimbit, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => "/^01[1,2,3,4,6,7,8,9]\d{7,8}$/")))) {
    ...
    if (empty($xCoor)) {
        ...
        $valid = false;
    } elseif (!filter_var($xCoor, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => "/^[-+]?\d+(\.\d+)?$/")))) {
    ...
    if (empty($yCoor)) {
        ...
        $valid = false;
    } elseif (!filter_var($yCoor, FILTER_VALIDATE_REGEXP, array("options" => array("regexp" => "/^[-+]?\d+(\.\d+)?$/")))) {
